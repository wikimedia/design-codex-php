 ...
 *
 * The `RadioRenderer` class leverages the `TemplateRenderer` and `Sanitizer` utilities to ensure the
...
class RadioRenderer implements IRenderer {
	...
	/**
	 * Constructor to initialize the RadioBarRenderer with a sanitizer and a template renderer.
	 *
	 * @since 0.1.0
	...
	public function render( $component ): string {
		...
		return $this->templateRenderer->render( 'radio.mustache', $radioData );
	}
}
