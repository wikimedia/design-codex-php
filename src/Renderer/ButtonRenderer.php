 ...
 *
 * The `ButtonRenderer` class leverages the `TemplateRenderer` and `Sanitizer` utilities to ensure the
...
class ButtonRenderer implements IRenderer {
	...
	/**
	 * Constructor to initialize the ButtonRenderer with a sanitizer and a template renderer.
	 *
	 * @since 0.1.0
